...
public class DungeonManiaController {
    ...
    public DungeonResponse saveGame(String name) throws IllegalArgumentException {
        ...
        // // jsonObj.addProperty("inventoryInvisibilityPotion",
            // game.getPlayer().getInventory().getEntities(InvisibilityPotion.class).size());
        // // jsonObj.addProperty("mapInvisibilityPotion",
                // game.getMap().getEntities(InvisibilityPotion.class).size());
        // // jsonObj.addProperty("inventoryInvincibilityPotion",
        //      game.getPlayer().getInventory().getEntities(InvincibilityPotion.class).size());
        // // jsonObj.addProperty("mapInvincibilityPotion", game.getMap().
            // getEntities(InvincibilityPotion.class).size());
